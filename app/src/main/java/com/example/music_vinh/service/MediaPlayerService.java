...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private Song activeAudio; //an object on the currently playing audio
...
//    }
    ...
    private void updateMetaData() {
        ...
        mediaSession.setMetadata(new MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, activeAudio.getNameArtist())
                .putString(MediaMetadataCompat.METADATA_KEY_ALBUM, activeAudio.getNameAlbum())
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        NotificationCompat.Builder notificationBuilder = (NotificationCompat.Builder) new NotificationCompat.Builder(this)
                ...
                .setContentText(activeAudio.getNameArtist())
                .setContentTitle(activeAudio.getNameAlbum())
